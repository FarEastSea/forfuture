...
class TaskSchedulerService:
    ...
    async def _mark_login_account_failure(
        ...
        *,
        ...
        from legacy.database import async_session
        from legacy.models.account import Account
        from legacy.services.account_risk_service import load_risk_control_config, mark_account_failure
    ...
    async def _load_active_tasks(self):
        from legacy.database import async_session
        from legacy.models.ai_task import AITask
    ...
    async def execute_auto_crawl(self):
        ...
        from legacy.services.account_risk_service import get_preferred_login_account, load_risk_control_config
        from sqlalchemy import select
    ...
    async def execute_task(self, task_id: int):
        ...
        from legacy.services.rag_service import rag_service
