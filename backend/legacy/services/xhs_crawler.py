...
class XHSCrawler:
    ...
    async def save_cookies_manual(self) -> dict:
        ...
        try:
            ...
            from legacy.services.account_risk_service import mark_account_verified
            from sqlalchemy import select
    ...
    async def _load_login_account(
        ...
        *,
        ...
        from legacy.database import async_session
        from legacy.models.account import Account
        from legacy.services.account_risk_service import get_preferred_login_account, is_login_account_eligible
        from sqlalchemy import select
    ...
    async def _mark_login_account_expired(self, login_account_id: int | None, *, reason: str):
        ...
        from legacy.database import async_session
        from legacy.models.account import Account
        from legacy.services.account_risk_service import mark_account_expired
                ...
                try:
                    ...
                    try:
                        ...
                        if user_info and (user_info.get("nickname") or user_info.get("avatar")):
                            from legacy.services.media_service import media_service as ms_sync
    ...
    async def _save_notes(self, uid: str, notes: list[dict], source: str):
        ...
        from legacy.database import async_session
        from legacy.models.xhs_post import XHSNote
        from legacy.services.media_service import media_service
        from sqlalchemy import select
    ...
    async def _poll_login_status(self):
        ...
        if self.login_status == "logged_in":
            from legacy.routers.ws import active_preview_platforms
